...
[![Version](https://img.shields.io/badge/version-5.6.3-D4A017?style=for-the-badge)](https://github.com/ivan-yurich/naiveproxy/releases)
...
Версия `5.6.3` закрепляет единый публичный бренд **Yurich Panel** и сохраняет инструменты v5.6.x: выбор языка SSH-панели, self-update с SHA256, pin версий ключевых компонентов, health-check, safe apply, encrypted backup, export/import и сроки подписок.
...
sudo bash yurich-panel.sh aurum-dns
```
