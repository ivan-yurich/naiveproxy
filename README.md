...
[![Version](https://img.shields.io/badge/version-5.6.8-D4A017?style=for-the-badge)](https://github.com/ivan-yurich/naiveproxy/releases)
...
Версия `5.6.8` исправляет отображение SSH-панели в VNC/serial-консолях и терминалах без emoji-шрифтов. Главное меню, диагностика, DNS-экраны и donate-экран переведены на terminal-safe ASCII-метки вроде `[DNS]`, `[WARP]`, `[XRAY]`, `[OK]`, `[WARN]`.
...
[Yurich Panel v5.6.8: большой обзор скрипта](ARTICLE_RU.md)
