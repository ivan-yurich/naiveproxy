...
[![Version](https://img.shields.io/badge/version-5.6.13-D4A017?style=for-the-badge)](https://github.com/ivan-yurich/naiveproxy/releases)
...
## Что нового в v5.6.13

Версия `5.6.13` добавляет базовое мультисерверное управление: главный сервер может хранить список node-серверов, проверять их по SSH, отправлять на них текущий скрипт, синхронизировать пользователей и добавлять дополнительные node-ссылки в страницы подписки.
...
[Yurich Panel v5.6.13: большой обзор скрипта](ARTICLE_RU.md)
...
- добавлены контакты проекта: Telegram, VK и `ai@ivan-it.net`;
