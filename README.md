...
[![Version](https://img.shields.io/badge/version-5.5.2-D4A017?style=for-the-badge)](https://github.com/ivan-yurich/naiveproxy/releases)
...
Версия `5.5.2` исправляет автогенерацию паролей Hysteria 2 и усиливает проверку Cloudflare WARP proxy mode.
