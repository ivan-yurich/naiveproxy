...
[![Version](https://img.shields.io/badge/version-5.6.12-D4A017?style=for-the-badge)](https://github.com/ivan-yurich/naiveproxy/releases)
...
## Что нового в v5.6.12

Версия `5.6.12` добавляет на персональные страницы подписки ссылки на Yurich Connect для Android и Windows, а также контакты проекта: Telegram, VK и email.
...
[Yurich Panel v5.6.12: большой обзор скрипта](ARTICLE_RU.md)
