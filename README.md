...
[![Version](https://img.shields.io/badge/version-5.5.13-D4A017?style=for-the-badge)](https://github.com/ivan-yurich/naiveproxy/releases)
...
## Что нового в v5.5.13

Версия `5.5.13` добавляет полноценную кнопку `Menu` в Telegram: бот сам публикует список команд через Bot API и оставляет русскую клавиатуру быстрых действий.
