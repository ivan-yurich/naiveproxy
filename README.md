...
[![Version](https://img.shields.io/badge/version-5.5.8-D4A017?style=for-the-badge)](https://github.com/ivan-yurich/naiveproxy/releases)
...
Версия `5.5.8` добавляет Unbound как отдельный DNS plugin, персональные Hysteria 2 профили для пользователей и защиту SSH при включении WARP full tunnel.
