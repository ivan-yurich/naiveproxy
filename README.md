...
[![Version](https://img.shields.io/badge/version-5.6.10-D4A017?style=for-the-badge)](https://github.com/ivan-yurich/naiveproxy/releases)
...
## Что нового в v5.6.10

Версия `5.6.10` добавляет рабочий XHTTP standalone на отдельном TLS-порту `8448/tcp`. Теперь XHTTP доступен без переключения `443` с Caddy/Yurich Proxy на Xray fallback hub.
...
[Yurich Panel v5.6.10: большой обзор скрипта](ARTICLE_RU.md)
