...
[![Version](https://img.shields.io/badge/version-5.5.11-D4A017?style=for-the-badge)](https://github.com/ivan-yurich/naiveproxy/releases)
...
## Что нового в v5.5.11

Версия `5.5.11` убирает рекламные blocklists из DNS-модуля и переводит его в безопасный Aurum DNS: собственный recursive Unbound для VPN-клиентов без open resolver.
...
Для VPN-клиентов DNS открывается только по указанным CIDR. Gateway IP должен уже быть назначен интерфейсу сервера, например `10.0.0.1`.
