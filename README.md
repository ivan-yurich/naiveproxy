<p align="center">
  <a href="README.md">Русский</a> · <a href="README_EN.md">English</a> · <a href="ARTICLE_RU.md">Большая статья</a> · <a href="MULTISERVER_GUIDE_RU.md">Мультисервер</a> · <a href="RELEASE_NOTES_RU.md">Релиз 5.6.49</a>
</p>
...
[![Version](https://img.shields.io/badge/version-5.6.49-D4A017?style=for-the-badge)](https://github.com/ivan-yurich/naiveproxy/releases)
...
| Release notes | Добавлен подробный файл [RELEASE_NOTES_RU.md](RELEASE_NOTES_RU.md) с перечнем исправлений и проверок |
...
- добавлены `SECURITY.md`, `.gitignore`, `.gitattributes` и подробные [release notes](RELEASE_NOTES_RU.md);
