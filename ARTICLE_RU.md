...
Yurich Panel 5.6.x — это большой шаг от простого установочного скрипта к полноценному инструменту администрирования. Он объединяет установку, конфигурацию, безопасность, диагностику, Telegram-управление, пользовательские подписки, дополнительные транспортные модули и базовое мультисерверное управление через node-реестр. В этой версии дополнительно добавлены команды для добавления VPS-нод, проверки их по SSH, синхронизации пользователей и генерации подписок с несколькими серверными ссылками.
